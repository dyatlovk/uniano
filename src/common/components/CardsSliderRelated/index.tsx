            ...
            <>
              ...
              >
                <SliderItem
                  ...
                  text="Professional business logo with copyrights "
    ...
    <div className={styles.slider_wrapper_item}>
      ...
      <div className="gap_5">
        ...
        <div style={{ display: 'flex', gap: '5px' }}>
          <Typography variant="body5" color="white" fontWeight="500">
            from ${priceFrom}
          </Typography>
          <Typography
            variant="body5"
...
export const CardsSliderParticipates = ({
  secondSlider = false,
}: {
  secondSlider?: boolean
}) => {
