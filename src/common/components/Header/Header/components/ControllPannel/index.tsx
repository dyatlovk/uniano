  ...
  return (
    <div className={styles.controll_pannel}>
      <MyButtonOrange
        ...
        fontWeight="500"
      >
        <div style={{ marginRight: 'auto', opacity: '0' }}>
          <AppColor.chevronRight height={'14px'} width={'7px'} fill="white" />
        </div>{' '}
        Customer{' '}
      ...
      <Link to={'/dashboard/home'}>
        <ControllItem
          callback={() => {}}
          icon={<AppColor.dashboard fill={AppColor.text} />}
          text="Dashboard"
        />
      </Link>
      ...
      <Link to={'/messenger/solutions'}>
        <ControllItem
          callback={() => {}}
          icon={<AppColor.message fill={AppColor.text} />}
          text="Messenger"
        />
      </Link>
      ...
      <Link to={'/settings/profile'}>
        <ControllItem
          callback={() => {}}
          icon={<AppColor.settings2 fill={AppColor.text} />}
          text="Settings"
        />
      </Link>
      <Link to={'/admin'}>
        ...
        >
          ...
          <div style={{ maxWidth: '390px' }} className="text_box">
            <Typography variant="body4">
              ...
              simple renovation of old plans or from your idea.
            </Typography>
          </div>
      ...
      {moderatorModalSubmit && (
        ...
        >
          <div style={{ maxWidth: '420px' }}>
            <Typography variant="body4">
              A <span style={{ fontWeight: '500' }}>moderator</span> on a
              website is a person, typically appointed by the website
              administrator, who is responsible for maintaining order and
              enforcing the rules on the site. To submit an application for
              moderator privileges, you must meet the following{' '}
      ...
      {arbitrationModal && (
        ...
        >
          <div style={{ maxWidth: '420px' }}>
            <Typography variant="body4">
              An <span style={{ fontWeight: '500' }}>arbitrator</span> is
              typically a neutral third-party who is appointed to resolve
              disputes between clients and freelancers. To submit an application
              for logo <span style={{ fontWeight: '500' }}>design</span>{' '}
              arbitrator privileges, you must meet the following{' '}
              <span style={{ fontWeight: '500' }}>requirements:</span>
            </Typography>
          </div>
...
const ChooseRole = ({
  ...
  return (
    <div
      ...
      className={`${styles.choose_role} cursor`}
      style={{
        backgroundColor: activeText == text ? AppColor.orange : 'transparent',
      }}
    >
      ...
      <Typography
        ...
        fontWeight="500"
        textTransform="uppercase"
        color={activeText == text ? 'white' : AppColor.text}
      >
        {text}
      </Typography>
      <SizeBox width="5px" />
      <AppColor.chevronRight
        ...
        width={'8px'}
        height={'16px'}
        fill={activeText == text ? 'white' : AppColor.transparent}
      />
    </div>
  )
}
...
const SelectModalModerator = ({
  ...
  title,
  selectedItem,
}: SelectModalModeratorProps) => {
  const [hovered, setHovered] = useState(false)
  return (
    <div
      style={selectedItem == title ? { backgroundColor: AppColor.white } : {}}
      className={`${styles.select_modal_moderator} cursor`}
    ...
    >
      ...
      <div className={styles.flex_column}>
        ...
        <Typography
          variant="body5"
          color={textColor ?? AppColor.transparentBlack}
        >
          {text}
        </Typography>
      </div>
      ...
      <div
        style={{
          opacity: selectedItem == title || hovered ? '1' : '0',
          marginLeft: 'auto',
        }}
        className={styles.flex_icon}
      >
        <AppColor.chevronRight
          width={'8px'}
          height={'16px'}
