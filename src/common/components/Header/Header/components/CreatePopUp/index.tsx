  ...
  return (
    <div className={styles.create_wrapper}>
      {showModalPersonalOrder && (
        <ModalCenter
          onClickHandler={() => {
            setShowModalPersonalOrder(false)
          }}
        >
            ...
            <div style={{ padding: '30px' }}>
                  ...
                  <UserItem
                    callback={() => {
                      const filtered = users.filter(
                        item => item.name != fakeUserConstant.name
                      )
                      setUsers(filtered)
                    }}
                  />
              ...
              <div className="text_box">
                <Typography variant="body4">
                  After inviting the desired freelancers, you will be taken to
                  the project details stage. Once the order is created, only the
                  selected freelancers will receive notifications about the
                  project invitation.
                </Typography>
              </div>
              <DynamicPadding desktop="30px" mobile="20px" />
      ...
      {showModalInviteToOrder && (
        <ModalCenter
          onClickHandler={() => {
            setShowModalInviteToOrder(false)
          }}
        >
          <div className="modal_wrapper_item">
            <div style={{ padding: '20px' }} className="flex_space_between">
            ...
            <div
              style={{ paddingLeft: '30px', width: 'fit-content' }}
              className="gap_10"
            >
              <PopUpBottom
            ...
            <div style={{ padding: '30px' }}>
              ...
              <div className="text_box">
                <Typography variant="body4">
                  After inviting the desired freelancers, the selected
                  freelancers will receive project invitation notifications.
                </Typography>
              </div>
              <DynamicPadding desktop="30px" mobile="20px" />
      ...
      <div
        ...
        style={{ padding: showOrder ? '30px' : '0px' }}
      >
        {showOrder && (
          <div style={{ whiteSpace: 'nowrap' }}>
            ...
            <div className={styles.grid_15}>
              <Link to={'/create-order/details'}>
                <Typography className={styles.hover_link} variant="body4">
                  Common Order
                </Typography>
              </Link>
              <div
                className="cursor"
                onClick={() => {
                  setShowModalPersonalOrder(true)
                }}
              >
                <Typography className={styles.hover_link} variant="body4">
                  Personal Offer
              ...
              <div
                className="cursor"
                onClick={() => {
                  setShowModalInviteToOrder(true)
                }}
              >
                {' '}
                <Typography className={styles.hover_link} variant="body4">
...
const UserItem = ({ callback }: { callback: (item: string) => void }) => {
  return (
    <div className="gap_10">
      ...
      <div
        onClick={() => {
          callback(fakeUserConstant.name)
        }}
        className="cursor"
      >
