    ...
    <div className={styles.roadmap_wrapper}>
      ...
      <div className={styles.flex_column}>
        <Typography textLineHeight="1" variant="body4" fontWeight="500">
          {title}{' '}
          {steps && <span style={{ color: AppColor.orange }}>{steps}</span>}
        </Typography>
        ...
        >
          <div style={{ display: 'flex', gap: '5px' }}>
            <UserAvatar
              ...
              height="20px"
            />
            <Typography variant="body4" fontWeight="500" color={AppColor.text}>
              John Doe
            </Typography>
          </div>
          <div className="gap_5">
...
export const RoadmapFlex = ({
  ...
  return (
    <div style={{ alignItems: 'center' }} className={styles.roadmap_wrapper}>
      ...
      {completed && (
        <div style={{ marginLeft: 'auto' }} className="gap_5">
          <AppColor.pigCoins />
          <Typography variant="body4">25</Typography>
        </div>
      )}
