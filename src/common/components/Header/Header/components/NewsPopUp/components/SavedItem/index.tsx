...
const listFilters = ['No list', 'My services', 'Freelancers', 'My partners']
const SavedItem = ({
  text,
  activeOpenFilter,
  callback,
          ...
          <div className="modal_wrapper_item">
            <div style={{ padding: '20px' }} className="flex_space_between">
              <div className="gap_20">
                ...
                <UserListSelect
                  index={index}
                  activeFilterIndex={activeOpenFilter}
                  callback={callback}
                />
              </div>
              <div
            ...
            <HorizontalLine />
            <div
              style={{ padding: '30px', maxHeight: '100%', overflowY: 'auto' }}
            >
              <MessagesDisplay
                maxHeight="60vh"
                selectBox={true}
      ...
      <div className={styles.saved_flex}>
        ...
        <div className={styles.icons_grid}>
          ...
          <div
            ...
            className={`${styles.icon_border} cursor`}
          >
