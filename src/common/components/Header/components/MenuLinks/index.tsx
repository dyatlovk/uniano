    ...
    <div className={styles.wrapper}>
      <div className={styles.links_wrapper}>
        <Link
          ...
          ImageNodeActive={
            <AppColor.cart width={'27px'} height={'27px'} fill="white" />
          }
          text="Services"
          index={0}
        />
        ...
        <Link
          ...
          ImageNodeActive={
            <AppColor.caseWhite fill="white" width={'30px'} height={'30px'} />
          }
          text="Sponsorships"
          index={2}
        />
      ...
      <div className={styles.content_wrapper}>
        <div className={styles.search_section}>
          ...
          <div className={styles.search_categorys}>
            <CategoryItem
              onHover={() => {
                setActiveCategory(categorysText.Development)
              }}
            ...
            <CategoryItem
              onHover={() => {
                setActiveCategory(categorysText.Design)
              }}
            ...
            <CategoryItem
              onHover={() => {
                setActiveCategory(categorysText.Marketing)
              }}
            ...
            <CategoryItem
              onHover={() => {
                setActiveCategory(categorysText.Writing)
              }}
            ...
            <CategoryItem
              onHover={() => {
                setActiveCategory(categorysText.Management)
              }}
            ...
            <CategoryItem
              onHover={() => {
                setActiveCategory(categorysText.Consulting)
              }}
            ...
            <div className={styles.category_link_wrapper}>
              <LinkRouter to={mapRoutes[activeTab]}>
                <Typography
                  ...
                  variant="body4"
                  fontWeight="500"
                  className={`${styles.color_title} cursor`}
                >
                  {item.title}
                </Typography>
              </LinkRouter>
...
export const MenuLinksAuthorized = ({
  hoveredLink,
}: {
  hoveredLink: number
}) => {
...
const Link = ({
  ...
  return (
    ...
    >
      ...
      <Typography
        variant="body7"
        color={activeIndex == index ? 'white' : AppColor.text}
        fontWeight="500"
        textLineHeight="100%"
      >
        {text}
