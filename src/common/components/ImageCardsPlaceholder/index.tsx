...
const BigImagePlaceholder = ({
  callback,
  height,
}: SmallImagePlaceholderProps) => {
  ...
  return (
    <div
      style={{ minHeight: height }}
      onClick={handleClick}
      className={`${styles.image_big_placeholder} cursor`}
    >
      <input
        ref={inputRef}
        type="file"
      ...
      <Typography variant="body4">
        Drop your image to upload or{' '}
        <span style={{ color: AppColor.orange, fontWeight: '500' }}>
          browse
        </span>
      </Typography>
    </div>
...
const SmallImagePlaceholder = ({ callback }: SmallImagePlaceholderProps) => {
  ...
  return (
    <div
      onClick={handleClick}
      className={`${styles.image_small_placeholder} cursor`}
    >
      <input
        ref={inputRef}
        type="file"
