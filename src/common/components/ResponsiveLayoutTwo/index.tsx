...
const ResponsiveLayoutTwo = ({
  ...
  return (
    <div style={styleItem} className={styles.main_part}>
      ...
      <div
        className={`${styles.left_part} ${item1ToAModalLeftMobile ? styles.modal : styles.no_modal}
                 ${showModal ? styles.show_modal : styles.hide_modal}`}
      >
        <div
          style={{ width: '100%' }}
          className={showModal && styles.overflow_modal}
        >
          {item1}
        </div>
      </div>
