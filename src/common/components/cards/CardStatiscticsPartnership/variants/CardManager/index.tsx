  ...
  return (
    <div className={styles.shell}>
      ...
      {!disableAbsoluteItems &&
        ...
        !isCancelled && (
          <div
            style={{ display: isSelected ? 'flex' : 'none', ...positionStyle }}
            className={styles.absolute_select}
          >
      ...
      {hired && (
        <div style={{ ...positionStyle }} className={styles.absolute_select}>
          <div className={styles.gap_20}>
            <Typography variant="body3" fontWeight="500">
              Moved
            </Typography>
        ...
        showCardManagerActions && (
          <div style={{ ...positionStyle }} className={styles.absolute_select}>
            <div className={styles.gap_20}>
              ...
              />
              <AppColor.speficChevronRightFilled />
              <Typography variant="body5" color={AppColor.red}>
                Cancelled
              </Typography>
            </div>
          </div>
