    ...
    <div className={styles.shell}>
      ...
      {topUsers != null &&
        topUsers.map((item, index) => {
          const totalOffset =
            topUsers.length > 1 ? (topUsers.length - 1) * 11 : 0
          const itemOffset = index == 0 ? totalOffset : totalOffset - index * 11
          return (
            <div
              style={{ right: `${itemOffset}px` }}
              className={styles.absolute_users}
            >
      ...
      >
        ...
        <div className={styles.content_top_second}>
          ...
          />
          <SvgText
            img={<AppColor.message fill="white" />}
      ...
      <div
        className={`${showBottomActions ? styles.middle_part : styles.shell_bottom}`}
      >
      ...
      {showBottomActions && (
        <div
          ...
          className={`${styles.activity_items}`}
        >
          <div>
            <AnimatedSvg
