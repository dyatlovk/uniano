...
export const StepThreeButtonAdd = ({
  callback,
  value,
  stepOneValue,
  stepTwoValue,
...
export const StepFourButtonAdd = ({
  callback,
  value,
  stepOneValue,
  stepTwoValue,
    ...
    <StepsOfPreparingEndSolving
      elements={[
        ...
        },
        {
          ...
          text: stepThreeValue,
          afterTextNode:
            stepThreeValue == 'Repeatable' ? (
              <AppColor.repeat width={'16px'} height={'16px'} />
            ) : (
              <AppColor.noRepeat width={'16px'} height={'16px'} />
            ),
          onSolveClick: () => {
            callbackStep(3)
          },
...
export const StepFiveButtonAdd = ({
  callback,
  value,
  stepOneValue,
  stepTwoValue,
          ...
          solveNode={
            <div className="gap_20">
              <SelectItemFive
                ...
                initValue={
                  tmpArray.includes('Free') || tmpArray.includes(' Free')
                }
                text="Free (default)"
              />
              <SelectItemFive
                ...
                initValue={
                  tmpArray.includes('Pro') || tmpArray.includes(' Pro')
                }
                text="Pro"
              />
              <SelectItemFive
...
export const StepSevenButtonAdd = ({
  callback,
  value,
  stepOneValue,
  stepTwoValue,
  ...
  return (
    <StepsOfPreparingEndSolving
      ...
      solvingNode={
        <StepItemSolving
          solveNode={<div className="gap_20"></div>}
          stepNumber="7"
          title="Purpose"
        />
      }
