      ...
      <div className={styles.details_part}>
        <div>
          <UserAvatar
            ...
            role={requestFrom == 'Customer' ? 'Customer' : 'Freelancer'}
          ...
          <div className="gap_10">
            <div className="gap_5">
              ...
              >
                {freelancerDetails.earned}
              </Typography>
              <div
                style={{ backgroundColor: AppColor.green }}
                className={styles.colored_box}
              >
            ...
            <div className="gap_5">
              ...
              >
                {freelancerDetails.discount}
              </Typography>
              <div
                style={{ backgroundColor: AppColor.transparentBlack }}
                className={styles.colored_box}
              >
                <Typography variant="body5" color="white">
                  12%
