          ...
          <DropdownContactUs
            ...
            dropdownNode={
              <div className={styles.grid_3}>
                <DropdownChild
                  callback={item => {
                    callback([selectedCategory, item])
                    callbackStep(2)
                  }}
                  icon={<AppColor.info />}
...
const DropdownChild = ({ icon, text, callback }) => {
  return (
    <div
      ...
      className={`${styles.dropdown_child} cursor`}
    >
      {icon}
      <Typography className={styles.hover_text_child} variant="body5">
        {text}
      </Typography>
    </div>
  )
...
const DropdownContactUs = ({
  callback,
  dropdownNode,
  text,
  activeSelect,
}: DropdownContactUsProps) => {
  ...
  return (
    <div>
      <div
        ...
        style={{
          opacity: isActive ? '0.73' : '1',
          backgroundColor: isActive ? AppColor.orange : 'transparent',
        }}
      >
        <Typography
          color={isActive ? 'white' : AppColor.text}
          variant="body5"
          fontWeight="500"
        >
          {text}
          ...
          solveNode={
            <div className="grid_15">
              ...
              <SecondStepItem
                ...
                text={`Why wasn't my promo code applied to my purchase?`}
              />
            </div>
          }
          stepNumber="2"
...
export const StepThreeContactUs = ({
  callback,
  value,
  stepOneValue,
  stepTwoValue,
    ...
    <StepsOfPreparingEndSolving
      ...
      solvingNode={
        <StepItemSolving
              ...
              {!contactUs ? (
                <div>
                  <Typography variant="body4" fontWeight="400">
                    ...
                    Nisi, tristique enim, neque, mollis at. Quam scelerisque
                    pulvinar pellentesque phasellus.
                  </Typography>
          ...
          stepNumber="3"
          title={!contactUs ? 'Try the following:' : 'Describe the issue'}
        />
      }
    />
  )
  ...
  return (
    <div>
      ...
      <div className={styles.related_topics}>
        {tmp.slice(0, showCount).map(item => (
          <div className="gap_5">
            <AppColor.questionFaq />
            <Typography className="underline_appearance" variant="body4">
              What is Uniano?
            </Typography>
          </div>
        ))}
      ...
      <SizeBox height="20px" />
      {showCount < tmp.length && (
        <div
          onClick={() => {
            setShowCount(prev => prev + 4)
          }}
          className={`${styles.border_cehvron} cursor`}
        >
          <AppColor.chevronBottom fill={AppColor.text} />
        </div>
      )}
