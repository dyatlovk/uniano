...
type DetailCrowdfreelanceProgressProps = {
    informationTable: DetailCrowdfreelanceProgressItem[];
    informationDropdown: DropdownMyProgramsItemProps[];
}

export type DetailCrowdfreelanceProgressItem = {

    page: number;
    
}
const DetailCrowdfreelanceProgress = ({informationTable,informationDropdown}:DetailCrowdfreelanceProgressProps) => {
...
export default DetailCrowdfreelanceProgress;