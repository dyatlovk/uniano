    ...
    return (
        <div className={styles.dropdown_wrapper}>
            ...
            <div className={styles.dropdown_content}>
                <DropdownText sizeBox={true} title="Hourly Rate" node={ <div className='gap_5'>
                    <Typography variant='body4' fontWeight='500'>$15/hr</Typography>
                    <AppColor.doubleUp />
                    <Typography variant='body4' fontWeight='500'>$30/hr</Typography>
                </div> } text='' />
                <DropdownText sizeBox={true} title="Workday Limit" node={ <div className='gap_5'>
                    <Typography variant='body4' fontWeight='500'>8 hrs</Typography>
                    <AppColor.doubleDown />
                    <Typography variant='body4' fontWeight='500'>10 hrs</Typography>
                </div> } text='' />
                <DropdownText sizeBox={true} title="Payment Release" node={ <div className='gap_5'>
                    <Typography variant='body4' fontWeight='500'>1 hr</Typography>
                    <AppColor.doubleUp />
                    <Typography variant='body4' fontWeight='500'>3 hrs</Typography>
                </div> } text='' />
                ...
                <DropdownText sizeBox={true} title="New Specifications" node={ <div className='gap_5'>
                    <Typography color={AppColor.transparentBlack} variant='body4' fontWeight='500'>View</Typography>
                </div> } text='' />
