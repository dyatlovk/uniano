...
const DetailsTableAdminCategoriesServices = ({information}:DetailsTableAdminCategoriesServicesProps) => {
        ...
        details={
            currentItem != null ? [
                ...
                },
                {
                    title: 'Group',
                    maxWidth: '110px',
                    child: <div style={{opacity: currentItem.group.toLowerCase() == 'no group' ? '0.3' : '1',padding: '4px 14px'}} className={styles.category_wrapper}>
                ...
                },
                {
                    title: 'Link',
                    maxWidth: '50px',
                    child:  <div style={{whiteSpace: 'pre-wrap'}}><Typography variant='body4'>{currentItem.link}</Typography></div>
                },
                {
                    title: 'New Tab',
