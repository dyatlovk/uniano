          ...
          <div className={styles.fields_grid}>
            <div style={{ width: '100%' }}>
              <div className={styles.field_wrapper}>
                <InputField initText={currentItem.page} title="Title" />
                ...
                <InputField
                  initText={
                    'freelance, freelance service, freelance marketplace'
                  }
                  title="Meta-keywords"
                />
              </div>
            ...
            <div className={styles.field_wrapper}>
              <InputField initText={'/'} title="Link" />
              <InputField initText={'/'} title="Redirect" />
              <InputField
                multiLine={true}
              ...
              },
              {
                ...
                child: (
                  <div
                    style={{
                      opacity:
                        currentItem.group.toLowerCase() == 'no group'
                          ? '0.3'
                          : '1',
                      padding: '4px 14px',
                    }}
              ...
              },
              {
                ...
                child: (
                  <div style={{ whiteSpace: 'pre-wrap' }}>
                    <Typography variant="body4">{currentItem.link}</Typography>
                  </div>
                ),
              },
              {
...
const tmpCategorys = ['no group', 'footer']
const GroupSelect = () => {
    ...
    <div>
      ...
      <div className={styles.dropdown_relative}>
        ...
        >
          <div
            style={{
              width: 'fit-content',
              padding: '4px 14px',
              opacity: group.toLocaleLowerCase() == 'no group' ? '0.3' : '1',
            }}
            className={styles.category_wrapper}
          >
            <Typography
        ...
        <div
          ...
          className={styles.absolute_dropdown_field}
        >
            ...
            >
              <div
                style={{
                  width: 'fit-content',
                  padding: '4px 14px',
                  opacity: item.toLocaleLowerCase() == 'no group' ? '0.3' : '1',
                }}
                className={styles.category_wrapper}
              >
                <Typography
...
export default DetailsTableAdminCategoriesServices
