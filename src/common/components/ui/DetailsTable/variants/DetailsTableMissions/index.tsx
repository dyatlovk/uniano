          ...
          ? [
              {
                ...
                child: (
                  <MissionItem
                    ...
                    completed={currentItem.missionCompleted}
                    text={currentItem.missionText}
                  />
                ),
              },
              {
                ...
                child: (
                  <div className={styles.limits_wrapper}>
                    <Typography variant="body4">
                      {currentItem.limitsCurrent} of {currentItem.limitsMax}
                    </Typography>
                    <PercentBar
                      width="80px"
                      height="5px"
                      currentPercent={
                        (currentItem.limitsCurrent / currentItem.limitsMax) *
                        100
                      }
                    />
                  </div>
