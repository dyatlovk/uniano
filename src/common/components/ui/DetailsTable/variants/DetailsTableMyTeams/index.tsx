            ...
            ? [
                {
                  ...
                  child: (
                    <TeamView
                      teamIcon={currentItem.teamIcon}
                      teamMembers={currentItem.teamMembers}
                ...
                },
                {
                  ...
                  child: (
                    <ContractItem
                      icon={<AppColor.contract />}
                      description={'till 26 Oct 2023'}
                      title="Signed (2/2)"
                    />
                  ),
                },
...
const ModalLeaveTemplate = ({
  ...
  typeColor,
  type,
}: ModalLeaveTemplateProps) => {
  return (
    <div>
      <Typography variant="body4">
        {text} <span style={{ fontWeight: '500' }}>{textBold}</span>
      </Typography>
      <SizeBox height="15px" />
      <div className="gap_10">
        ...
        {type && (
          <div style={{ marginLeft: 'auto' }}>
            <Typography variant="body5" color={typeColor} fontWeight="500">
              {type}
            </Typography>
          </div>
        )}
      ...
      <div className={styles.flex_end}>
        ...
        {buttonsSecond.color == 'orange' ? (
          <MyButtonOrange
            disabled={buttonsSecond.disabled}
            onClick={buttonsSecond.onClick}
            fontWeight="500"
            textTransform="uppercase"
          >
            {buttonsSecond.text}
