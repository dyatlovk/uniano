...
export const StepTwoButtonAddPortfolio = ({
  callback,
  value,
  stepOneValue,
  callbackStep,
...
export const StepThreeButtonAddPortfolio = ({
  callback,
  value,
  stepOneValue,
  stepTwoValue,
        ...
        <StepItemSolving
          solveNode={
            <div className={styles.grid_3}>
              {skills.map(item => (
                <SkillSelectTmp
                  initValueProp={array.includes(item)}
                  text={item}
                  callback={(text, isTrue) => {
                    if (isTrue) {
...
export const StepFourButtonAddPortfolio = ({
  callback,
  value,
  stepOneValue,
  stepTwoValue,
...
export const StepFiveButtonAddPortfolio = ({
  callback,
  value,
  stepOneValue,
  stepTwoValue,
...
export const StepSixButtonAddPortfolio = ({
  callback,
  value,
  stepOneValue,
  stepTwoValue,
...
const StepSixComponent = ({ icon, title, onClick, activeSelection }) => {
  return (
    <div
      style={activeSelection == title ? { backgroundColor: '#F5F5F5' } : {}}
      onClick={() => {
        onClick(title)
      }}
      className={`${styles.step_six_component} cursor`}
    >
...
export const StepSevenButtonAddPortfolio = ({
  callback,
  value,
  stepOneValue,
  stepTwoValue,
...
export const StepFinalPortfolio = ({
  callback,
  value,
  stepOneValue,
  stepTwoValue,
...
const StepSevenComponentChoose = ({ firstItem }: { firstItem?: boolean }) => {
  return (
    <div
      style={firstItem ? { backgroundColor: 'transparent' } : {}}
      className={styles.seven_choose_item}
    >
      ...
      <div className={styles.flex_column}>
        ...
        <div className="gap_5">
          <Typography variant="body5" className={styles.hover_text}>
            A. Markevych
          </Typography>
          <Typography variant="body5" className={styles.hover_text}>
...
export const SelectItemSix = ({
  ...
  return (
    <div
      ...
      className={`${styles.select_six} cursor`}
    >
      <Typography
        variant="body4"
        fontWeight="500"
...
const StepThreeItem = ({
  ...
  return (
    <div
      style={activeItem == text ? { backgroundColor: AppColor.white } : {}}
      onClick={() => {
        callback(text)
      }}
