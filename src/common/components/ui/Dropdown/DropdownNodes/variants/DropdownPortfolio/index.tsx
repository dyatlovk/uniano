...
import {
  ...
  StepThreeButtonAddPortfolio,
  StepFourButtonAddPortfolio,
  StepFiveButtonAddPortfolio,
  StepSixButtonAddPortfolio,
  StepSevenButtonAddPortfolio,
  StepTwoButtonAddPortfolio,
  StepFinalPortfolio,
} from './Steps'
                ...
                {activeStep != 8 && (
                  <MyButtonOrange
                    disabled={
                      ...
                      mapsOfValues[activeStep] == '' ||
                      mapsOfValues[activeStep].length == 0
                    }
                    onClick={() => {
                      setActiveStep(prev => prev + 1)
                    }}
      ...
      {showModal && (
        ...
        >
          ...
          <Typography variant="body4">
            ...
            ullamcorper magna mi integer elementum dictum aenean in. Ultrices
            convallis in sit venenatis, ut nunc pellentesque. Eu lacus sapien et
            eu tortor cursus dolor. Nunc nunc, consequat porttitor sed tortor.
            Tempus mi sit blandit nibh fusce morbi nullam. Nunc sagittis tortor,
            dictum lorem quis faucibus elit. Pretium fames leo ut eget augue
            velit eros, pellentesque. Non quis imperdiet dui praesent at massa.
            Bibendum commodo eros bibendum sit cras sit venenatis, vulputate a.
            Et aliquet eu et tristique nibh ultrices vel amet amet. Sit facilisi
            pretium ut placerat sem. Sit nunc integer velit facilisi adipiscing
            lectus arcu. Pellentesque sapien, arcu, nulla quis magnis praesent
            aliquet venenatis.
          </Typography>
          <DynamicPadding desktop="30px" mobile="15px" />
          ...
          <div className="dropnodes">
            <div className={styles.node_wrapper}>
              {(() => {
                ...
                for (
                  let index = 0;
                  index < dropdownItems.length && index + 1 <= showItemsCount;
                  index++
                ) {
                  displayedItems.push(
                    <DropdownItem
        ...
        <div className="gap_10">
          ...
          <div className={styles.flex_column} style={{ alignItems: 'start' }}>
            ...
            <div className="gap_5">
              <Typography
                variant="body5"
                className={`${styles.hover_dark} cursor`}
              >
                Logo Design
              </Typography>
              <Typography
  ...
  return (
    <div>
      <div
        ...
        className={`${styles.port_dropdown_item} cursor`}
      >
        <img
          src={test1}
          width={'100%'}
