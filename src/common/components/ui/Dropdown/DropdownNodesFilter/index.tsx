...
const DropdownNodeFilter = ({
  ...
  return (
    <div className={styles.wrapper}>
        ...
        <div className={styles.title_shell}>
          <div className="gap_10">
            <Typography
              variant="body3"
              color={
                isActive ? '#515151' : AppColor.colorWithOpacity('#515151', 0.5)
              }
            >
              {title}
            </Typography>
            {countNotifications > 0 ? (
              <span className={styles.count_notifications}>
                {' '}
                <Typography
                  textLineHeight="100%"
                  variant="body3"
      ...
      <div
        className={`${isActive ? styles.description_block_active : styles.description_block}`}
      >
  ...
  return (
    ...
    >
      <Typography
        ...
        color={active ? AppColor.orange : AppColor.text}
      >
        {' '}
        {text}{' '}
      </Typography>
