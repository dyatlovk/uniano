...
import CardsSliderRelated, {
  CardsSliderParticipates,
} from '../../CardsSliderRelated'
...
const HoverDotsBox = () => {
  ...
  return (
    <div
      ...
      className={`${styles.wrapper_dots} cursor`}
    >
      {showModal && (
        <ModalCenterBasic
            ...
            <div style={{ padding: '30px', paddingBottom: '0px' }}>
              <div className="gap_10">
                ...
                <div className={styles.flex_column}>
                  ...
                  <div className="gap_5">
                    <Typography variant="body4" className={styles.hover_text}>
                      A. Markevych
                    </Typography>
              ...
              <Typography variant="body4">
                ...
                professional plans in 2d or 3d from your own sketches, pictures
              ...
              <div className="gap_20">
                ...
                <div className={styles.flex_column}>
                  ...
                  <Typography variant="body4">
                    Users holding 1-10 places will receive a Gold Reward Pack
                    containing Navination memorabilia items. More:
                    https://go.dmarket.com/reward-gold
                  </Typography>
                </div>
              </div>
    ...
    >
      {showModal && (
        ...
        >
          <>
            <Typography variant="body4">
              Pixel scrolling vector figma strikethrough main list. Align style
              blur rectangle link share vertical. Duplicate vertical underline
              opacity clip pencil overflow create arrange. Select flatten figma
              list flatten bullet figjam scrolling. Overflow ipsum asset line
              editor fill group list. Auto star clip flatten auto opacity.
            </Typography>
