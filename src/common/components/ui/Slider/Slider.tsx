  ...
  return (
    <div
      style={
        maxShowCount
          ? {
              maxWidth: `${maxShowCount * itemWidth + gap * gapsDisplay + 100}px`,
              width: '100%',
              padding: padding,
            }
          : { padding: padding }
      }
      className={styles.overflow_shell}
    >
      <div className={styles.shell}>
        ...
        >
          <div
            style={{
              gap,
              transform: `translateX(-${currentIndex * itemWidth + currentIndex * gap}px)`,
            }}
        ...
        {!removeButtons && (
          <span
            style={{
              width: buttonSize,
              height: buttonSize,
              right: `calc(100% + ${buttonLeft})` ?? `calc(100% + 50px)`,
            }}
            className={styles.left + ' ' + style}
          >
            <span
        ...
        {!removeButtons && (
          <span
            style={{
              width: buttonSize,
              height: buttonSize,
              left: `calc(100% + ${buttonRight})` ?? `calc(100% - 50px)`,
            }}
            className={styles.right + ' ' + style}
          >
            <span
              style={{ width: buttonSize, height: buttonSize }}
              onClick={moveOn}
