          ...
          nodeAfterTitle={
            <div className="gap_5">
              ...
              <Typography variant="body4" fontWeight="500">
                <span style={{ color: AppColor.green }}>96 </span>Trust Score
              </Typography>
            </div>
          }
        >
          <>
            <Typography variant="body4">
              <span style={{ fontWeight: '500' }}>Trust score</span> indicates
              the level of confidence to complete the offered service or order.
            ...
            <ul className={styles.list}>
              ...
              <li>guarantee</li>
              <li>reviews</li>
              <li>compliance of skill, user level and price</li>
              <li>statistics</li>
            </ul>
            ...
            <Typography variant="body4">
              ...
              is a very high level of reliability to complete a successful
              project.
            </Typography>
            <SizeBox height="5px" />
            <Typography variant="body4">
              <span style={{ color: '#B6DE59' }}>81-90 Trust Score</span>
              is a good probability to have perfect results.
            </Typography>
            <SizeBox height="5px" />

            <Typography variant="body4">
              <span style={{ color: AppColor.yellow }}>71-80 Trust Score</span>
              is a moderate risk to complete a successful project.
            </Typography>
            <SizeBox height="5px" />
            <Typography variant="body4">
              <span style={{ color: AppColor.orange }}>61-70 Trust Score</span>
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <feColorMatrix
            type="matrix"
            values="0 0 0 0 0.364706 0 0 0 0 0.831373 0 0 0 0 0.145098 0 0 0 0.3 0"
          />
          <feBlend
            mode="normal"
            in2="BackgroundImageFix"
            result="effect1_dropShadow_1912_107502"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_1912_107502"
            result="shape"
          />
        </filter>
      </defs>
...
const SimpleLineChart = () => {
  return (
    ...
    >
      ...
      <YAxis
        display={'none'}
        dataKey={'completedProjectsPercent'}
        type="number"
      />
      <Tooltip
