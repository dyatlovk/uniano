          ...
          <div className="modal_wrapper_item">
            ...
            <div className={styles.add_bottom_part}>
              ...
              <div className="gap_5">
                ...
                <MyButtonOrange
                  disabled={newListName.length > 18}
                  textTransform="uppercase"
                  fontWeight="500"
                  onClick={() => {
                    setShowAddModal(false)
                    setListFilters(prev => [...prev, newListName])
                  }}
                >
                  Create
                </MyButtonOrange>
      ...
      <div className={styles.flex_column}>
        ...
        >
          <Typography variant="body5" color={AppColor.transparentBlack}>
            Users •{' '}
            <span
              style={{ fontWeight: activeFilterIndex == index ? '500' : '400' }}
            >
              {listFilter}
            </span>
          </Typography>
            ...
            <div className={styles.absolute_show}>
              <div className={styles.absolute_top}>
                <div
                  ...
                  className={`${styles.orange_box} cursor`}
                >
              ...
              <div className={styles.absolute_grid}>
                {listFilters.map(item => (
                  <div
                    ...
                    className={`${styles.absolute_item_grid} cursor`}
                  >
                    <Typography
                      fontWeight={item == listFilter ? '500' : '400'}
                      variant="body5"
                    >
                      {item}
                    </Typography>
