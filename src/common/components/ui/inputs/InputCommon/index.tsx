...
const InputCommon = ({
  ...
  return (
    <div
      ...
      style={{ width: width, height: multiLine ? '100%' : 'auto' }}
    >
      ...
      {multiLine ? (
        <>
          <textarea
            ...
            style={{
              boxShadow: boxShadowNone && 'none',
              borderRadius: borderRadius ?? '20px',
              height: '100%',
              color: textColor ?? AppColor.text,
              padding: padding,
              paddingRight: `${rightPadding + 20}px`,
              paddingLeft: icon ? `${rightPadding + 25}px` : '15px',
              textAlign: textAlingCenter ? 'center' : 'start',
        ...
        <>
          ...
          <div
            ...
            style={{
              opacity: text != '' && hovered && !disableClose ? '1' : '0',
