...
const AdminList = () => {
  ...
  const [filtersOtherArbitrator, setFiltersOtherArbitrator] = useState<
    string[]
  >([])
  ...
  const [filtersOtherFreelancer, setFiltersOtherFreelancer] = useState<
    string[]
  >([])
      ...
      {managerSettings && (
        ...
        >
          <>
            ...
            <InputDropdown
              padding="15px 20px"
              dropdownVariants={['200 of unlimited ', '1,2', '3,5']}
              initText="200 of unlimited "
              labelIcon={<></>}
              marginLeft={true}
            />
            ...
            <InputDropdown
              ...
              padding="13px 20px"
              callback={item => {
                setLocationsManager(prev => [...prev, item])
              }}
            />
            ...
            <InputDropdown
              ...
              padding="13px 20px"
              callback={item => {
                setLanguagesManager(prev => [...prev, item])
              }}
            />
            ...
            <InputDropdown
              ...
              padding="13px 20px"
              callback={item => {
                setFiltersOtherManager(prev => [...prev, item])
              }}
            />
            ...
            <div className="gap_20">
              <RadioButton
                ...
                callback={item => {
                  setSelectedVariantArbitrator(item)
                }}
                indexItem={1}
                text=" New programs"
              />
        ...
        >
          <>
            ...
            <InputDropdown
              ...
              padding="13px 20px"
              callback={item => {
                setLocationsFreelancer(prev => [...prev, item])
              }}
            />
            ...
            <InputDropdown
              ...
              padding="13px 20px"
              callback={item => {
                setLanguagesFreelancer(prev => [...prev, item])
              }}
            />
            ...
            <InputDropdown
              ...
              padding="13px 20px"
              callback={item => {
                setFiltersOtherFreelancer(prev => [...prev, item])
              }}
            />
        ...
        >
          <>
            ...
            <InputDropdown
              ...
              padding="13px 20px"
              callback={item => {
                setLocationsModerator(prev => [...prev, item])
              }}
            />
            ...
            <InputDropdown
              ...
              padding="13px 20px"
              callback={item => {
                setLanguagesModerator(prev => [...prev, item])
              }}
            />
            ...
            <InputDropdown
              ...
              padding="13px 20px"
              callback={item => {
                setFiltersOtherModerator(prev => [...prev, item])
              }}
            />
              ...
              items={[
                {
                  ...
                  initValue: true,
                  isBoolean: false,
                  items: ['0.01', '0.1', '1', '10', '100', '1000', '10000'],
                },
                {
        ...
        >
          <>
            ...
            <InputDropdown
              ...
              padding="13px 20px"
              callback={item => {
                setLocationsArbitrator(prev => [...prev, item])
              }}
            />
            ...
            <InputDropdown
              ...
              padding="13px 20px"
              callback={item => {
                setLanguageArbitrators(prev => [...prev, item])
              }}
            />
            ...
            <InputDropdown
              ...
              padding="13px 20px"
              callback={item => {
                setFiltersOtherArbitrator(prev => [...prev, item])
              }}
            />
