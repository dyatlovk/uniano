        ...
        >
          <>
                  ...
                  nodes={Array.from({ length: 10 }, (_, index) => ({
                    ...
                    item: (
                      <Typography variant="body4">
                        Completed project without a review
                      </Typography>
                    ),
                  }))}
                />
              ...
              <div>
                ...
                <DropdownCustomNodesCenter
                  nodes={Array.from({ length: 5 }, (_, index) => ({
                    id: (index + 1).toString(),
                    item: (
                      <Typography variant="body4">{index + 1} times</Typography>
                    ),
                  }))}
                />
              </div>
              <div>
                ...
                <DropdownCustomNodesCenter
                  nodes={Array.from({ length: 24 }, (_, index) => ({
                    id: (index + 1).toString(),
                    item: (
                      <Typography variant="body4">{index + 1} hrs</Typography>
                    ),
                  }))}
                />
              </div>
            ...
            <InputDropdown
              padding="15px 20px"
              marginLeft={true}
              dropdownVariants={['Email & site', '1', '2']}
              initText="Email & site"
              labelIcon={<></>}
            />
            <DynamicPadding desktop="30px" mobile="20px" />
      ...
      <div className={styles.mobile_padding}>
        ...
        <div className={styles.top_part_flex}>
          <div className={styles.title_plus}>
            ...
            <div
              className={`${styles.orange} cursor`}
              onClick={() => {
                setAddScript(true)
              }}
            >
