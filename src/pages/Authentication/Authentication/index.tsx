...
const Authentication = () => {
  ...
  return (
    <div
      ...
      className={styles.opacity_wrapper}
    >
      <VariantChoose />
    </div>
  )
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.content_part}>
        ...
        <div style={{ opacity: '0' }} className={styles.first_flex}></div>
      </div>
    </div>
  )
}
      ...
      <div className={styles.content_part}>
        ...
        <div className={styles.center}>
          ...
          <Typography variant="body4">
            ...
            <span style={{ fontWeight: '500' }}>+380*******31.</span> Enter it
            below.{' '}
          </Typography>
    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.content_part}>
        ...
        <div className={styles.center}>
          ...
          <Typography variant="body4">
            A 6-digit verification code has been sent to{' '}
            <span style={{ fontWeight: '500' }}>in***@gmail.com.</span> Enter it
            below.{' '}
          </Typography>
          <DynamicPadding desktop="30px" mobile="20px" />
          <InputBorderText
    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.content_part}>
        ...
        <div className={styles.center}>
          ...
          <DynamicPadding />
          <Typography variant="body4">
            Please confirm you are the account holder. Select a verification
            option:
          </Typography>
          <DynamicPadding desktop="30px" mobile="20px" />
          <div>
          ...
          <div className={styles.flex_end}>
            ...
            <MyButtonOrange
              ...
              fontWeight="500"
              onClick={() => {
                callback(selectedVariant == 1 ? 'phone' : 'email')
              }}
            >
              Next
            </MyButtonOrange>
