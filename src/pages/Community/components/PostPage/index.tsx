            ...
            <div>
              ...
              {!showRateStatistics && (
                <div className={styles.radio_wrapper}>
                  ...
                  <RadioButton
                    text="Share my profile in social media"
                    activeSelection={radioValue == 0}
                    callback={item => {
                      setRadioValue(item)
                    }}
                    indexItem={0}
                ...
                <div style={{ maxWidth: '600px' }}>
                  ...
                  <div className="flex_space_between">
                    <Typography variant="body4">
                      Share my profile in social media
                    </Typography>
                    <Typography variant="body4" fontWeight="500">
                      70% (35)
                    </Typography>
                  ...
                  <DynamicPadding desktop="15px" mobile="10px" />
                  <Typography variant="body4">
                    <span style={{ fontWeight: '500' }}>36</span> votes
                  </Typography>
                </div>
              )}
  ...
  return (
    <div className={styles.post_details_wrapper}>
      ...
      <div className={styles.details_post_last}>
        ...
        <Typography variant="body4" color={AppColor.orange}>
          {percentLike}% users like this post{' '}
        </Typography>
        <AppColor.like />
        <AppColor.dislike />
      </div>
