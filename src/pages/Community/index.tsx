...
const CommunityPosts = () => {
  ...
  return (
    <div>
      <Header />
      <NavigationBar activePageIndex={0} currentCategoryTitle="Community" />
      <div className={styles.wrapper}>
        ...
        <SearchFilterBar
          callback={item => {
            setCurrentActiveTitle(item)
          }}
          currentActiveTitle={currentActiveTitle}
          recent={true}
        />
      ...
      {width <= 768 && (
        <div className={styles.flex_full}>
          <div className={styles.flex_item_filter_text}>
            <div
              className={styles.flex_item_filter_text}
              onClick={e => {
                handleOpen(e)
              }}
            >
              <Typography textLineHeight="0" variant="body3" fontWeight="500">
            ...
            <div
              ...
              className={styles.dropdown_wrapper_filter}
            >
              <div
                onClick={() => {
                  setCurrentActiveCategory('Getting Started')
                }}
              >
                <DropdownList
                  title="Getting Started"
              ...
              <div
                onClick={() => {
                  setCurrentActiveCategory('Subscription')
                }}
              >
                <DropdownList
                  title="Subscription"
              ...
              <div
                onClick={() => {
                  setCurrentActiveCategory('Services')
                }}
              >
                <DropdownList
                  title="Services"
              ...
              <div
                onClick={() => {
                  setCurrentActiveCategory('Orders')
                }}
              >
                <DropdownList
                  title="Orders"
              ...
              <div
                onClick={() => {
                  setCurrentActiveCategory('Crowdfreelance')
                }}
              >
                <DropdownList
                  title="Crowdfreelance"
              ...
              <div
                onClick={() => {
                  setCurrentActiveCategory('Partnership')
                }}
              >
                <DropdownList
                  title="Partnership"
              ...
              <div
                onClick={() => {
                  setCurrentActiveCategory('Missions')
                }}
              >
                <DropdownList
                  title="Missions"
              ...
              <div
                onClick={() => {
                  setCurrentActiveCategory('Payments')
                }}
              >
                <DropdownList
                  title="Payments"
