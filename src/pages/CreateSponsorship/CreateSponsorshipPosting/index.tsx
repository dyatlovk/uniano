...
const OverviewBlock = () => {
    ...
    return (
        ...
        item1={
            <div>
                <DynamicPadding />
                <Typography variant='body3' fontWeight='500'>Campaign stages</Typography>
                ...
                <div className='flex_space_between desktop'>
                    <Typography variant='body4' fontWeight='500' color={AppColor.orange}>Campaign</Typography>
                ...
                <div className='mobile'>
                <Typography variant='body4' fontWeight='500'>Campaign</Typography>
                </div>
                <DynamicPadding />
...
export default CreateSponsorshipPosting;