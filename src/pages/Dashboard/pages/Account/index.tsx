...
const Account = () => {
  ...
  const currentDropdonw = developmentDropdown.find(
    item => item.title == editModalCategory
  )
  ...
  const [processEditLanguage, setProcessEditLangauge] = useState<LanguageType>({
    flag: <></>,
    language: '',
    level: '',
  })
  const editableLanguage = languages.find(
    ...
    <div>
            ...
            <div className={styles.top_level_skills}>
              ...
              <div className={styles.profile_top_level}>
                ...
                <div
                  ...
                  className={`${styles.margin_left} cursor`}
                >
                  <Typography
                    variant="body4"
                    fontWeight="500"
        ...
        <ModalCenterBasic
          ...
          nodeAfterTitle={
            <div className="gap_10">
              ...
              <div className="gap_5">
                <Typography variant="body4">1 of 3 skills selected</Typography>
                <AppColor.upCirlcle />
              </div>
            </div>
          }
      ...
      {educationModal && (
        <ModalCenterBasic
          ...
          nodeAfterTitle={<DarkBox text={`${languages.length}`} />}
          topPartPadding="20px 30p"
          callbackClose={() => {
        ...
        >
          {languages.map(item => (
            <EducationModalItem
              college="Ukranian National Technical University"
              degree="M.A. Degree. Ecommerce"
      ...
      {addEducationModal && (
        ...
        >
          ...
          <InputDropdown
            marginLeft={true}
            initText="Select year"
            labelIcon={<></>}
            dropdownVariants={Array.from({ length: 2025 }, (_, index) =>
              index.toString()
            )}
          />
          <DynamicPadding desktop="30px" mobile="20px" />
      ...
      {editLanguageModal != '' && (
        ...
        >
          ...
          <DropdownLanguages
            callback={item => {
              setProcessEditLangauge(item)
            }}
            initLanguage={editableLanguage}
          />
        ...
        >
          {languages.map(item => (
            <LanduageModalItem
              level={item.level}
              text={item.language}
              callbackRemove={passLanguage => {
                setLanguages(prev =>
                  prev.filter(item => item.language !== passLanguage)
                )
              }}
              openEditModal={item => {
                setEditLanguageModal(item)
              }}
            />
          ))}
          <DynamicPadding desktop="30px" mobile="20px" />
        ...
        >
          ...
          <div className={styles.edit_grid}>
            <div className={styles.edit_grid_left}>
              ...
              <CategorySelect
                activeSelect={editModalCategory}
                callback={item => {
                  setEditModalCategory(item)
                }}
                icon={<AppColor.development />}
                title="Development"
              />
                            ...
                            setSkillsContent(prev =>
                              prev.map(skill => {
                                if (skill.title == currentDropdonw.title) {
                                  return {
                                    icon: skill.icon,
                                    skills: skill.skills.filter(
                                      skilltmp => skilltmp !== item
                                    ),
                                    title: skill.title,
                                  }
                                }
      ...
      <Header />
      <NavigationBar currentCategoryTitle="Dashboard" activePageIndex={1} />
          ...
          <div className={styles.top_flex}>
            ...
            >
              <div className={styles.flex_center}>
                Account <AppColor.openEye />
              </div>
            </Typography>
          </div>
          <ButtonDropdownSelect
            text="PROJECTS"
            variants={['PROJECTS', '2', '3']}
          />
        </div>
          ...
          <div className={styles.main_left}>
            ...
            <div>
              <Typography textLineHeight="1" variant="body2" fontWeight="500">
                <div className="gap_10">
                  {' '}
                  Certifications <AppColor.noteText />{' '}
                </div>
              </Typography>
              <DynamicPadding mobile="20px" desktop="30px" />
              <div>
            ...
            <ContentShell
              ...
              node={
                <Typography color={AppColor.transparentBlack} variant="body4">
                  {descriptionText != '' ? descriptionText : 'No info'}
                </Typography>
              }
            />
            <ContentShell
...
const LevelRowItem = ({ title, description, icon }) => {
  return (
    <div className="gap_10" style={{ alignItems: 'stretch' }}>
      <div className={styles.level_green_circle}>{icon}</div>
...
const SkillItemNode = ({ filter, fixed, hourly }: SkillItemNodeProps) => {
  return (
    <div>
      ...
      <Typography variant="body4" color={AppColor.transparentBlack}>
        Fixed Budget{' '}
        <span style={{ fontWeight: '500', color: AppColor.text }}>
          from {fixed}
        </span>
      </Typography>
      <SizeBox height="10px" />
...
const ContentShell = ({ node, title }: ContentShellProps) => {
  return (
    <div className={styles.content_shell_wrapper}>
      <div className={styles.content_shell_top}>{title}</div>
      <div className={styles.horizontal_line}></div>
...
const DetailInfo = ({ details, title }: DetailInfoProps) => {
  return (
    <div className={styles.details_info}>
      ...
      <Typography variant="body4" textLineHeight="60%" fontWeight="500">
        {details}
      </Typography>
    </div>
  )
...
export const DropdownLanguages = ({
  initLanguage,
  callback,
}: DropdownLanguagesProps) => {
  const [currentLanguage, setCurrentlaguage] =
    useState<LanguageType>(initLanguage)
  ...
  return (
    <div style={{ position: 'relative' }}>
      <div
        ...
        style={{ ...borderStyles }}
        className={`${styles.dropdown_languages} cursor`}
      >
      ...
      <div
        className={styles.absolute_language}
        style={{ display: showDropdown ? 'grid' : 'none' }}
      >
        ...
        {allCountries.map(item => (
          <div className="cursor">
            <CountrySelect
              activeCountry={currentLanguage.language}
              callback={item => {
...
const CountrySelect = ({
  ...
  return (
    ...
    >
      ...
      <Typography
        variant="body4"
        fontWeight={country.language == activeCountry ? '500' : '400'}
      >
        {country.language}
      </Typography>
    </div>
...
const DropdownSkills = () => {
  ...
  return (
    <div className={styles.dropdown_skills_wrapper}>
      ...
      <div
        className={`${styles.dropdown_wrapper} ${showDropdown ? styles.active_d : styles.disabled_d}`}
      >
        {skillsContent.map((item, index) => {
...
const EducationModalItem = ({
  college,
  degree,
  graduated,
}: EducationModalItemProps) => {
  return (
...
const LanduageModalItem = ({
  level,
  openEditModal,
  text,
  callbackRemove,
}: LanduageModalItemProps) => {
  return (
    <div
      onClick={() => {
        openEditModal(text)
      }}
      className={`${styles.language_select} cursor`}
    >
...
const SkillsItem = ({
  ...
  return (
    <div
      ...
      style={activeCategory == title ? { backgroundColor: AppColor.white } : {}}
    ...
    >
      ...
      {showDropdown ? (
        <div className={styles.skills_chevron}>
