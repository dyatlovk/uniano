...
import DetailsTableActivity, {
  DetailsTableActivityPropsItem,
} from '@common/components/ui/DetailsTable/variants/DetailsTableActivity/index'
...
const missionContent: DetailsTableActivityPropsItem[] = [
  {
    ...
    actionText:
      'Convert an Indicator Signal and an EA Signal into a Metatrader 5 Expert...',
...
const Activity = () => {
  return (
    <div>
      <Header />
      <NavigationBar currentCategoryTitle="Dashboard" activePageIndex={5} />
