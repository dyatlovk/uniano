...
const Rewards = () => {
  return (
    <div>
      <Header />
      <NavigationBar activePageIndex={3} currentCategoryTitle="Dashboard" />
        ...
        <div className={styles.top_section}>
          <div className={styles.top_flex}>
            ...
            <Typography
              ...
              fontWeight="600"
            >
              <div className={styles.flex_center}>rewards </div>
            </Typography>
          </div>
          <div className="gap_10">
            <ButtonDropdownSelect
              text="Customer"
              variants={['Customer', '2', '3']}
            />
            <AddRewardButton />
          </div>
        </div>
    ...
    <>
      {showDatails && (
        <ModalCenterBasic
          ...
          callbackClose={() => setShowDatails(false)}
          title="Reward’s details"
        >
          <RewardDetails
            item={{
              image,
      ...
      <div className={styles.reward_wrapper}>
        {count != null && (
          <div className={styles.reward_absolute_item_left}>
    ...
    <div>
      ...
      <div style={{ position: 'relative' }}>
        ...
        <div className={styles.absolute_box}>
          <div style={{ width: 'fit-content', border: '10px solid #fff' }}>
            <DarkBox fonstSize="13px" text="MISSION" />
          </div>
        </div>
      </div>
      <DynamicPadding desktop="30px" mobile="10px" />
      ...
      <div style={{ position: 'relative' }}>
        ...
        <div className={styles.absolute_box}>
          <div style={{ width: 'fit-content', border: '10px solid #fff' }}>
            <DarkBox fonstSize="13px" text="CAN BE USED" />
          </div>
        </div>
      </div>
      ...
      <div className="flex_space_between">
        ...
        <Typography
          className="underline_appearance orange"
          variant="body5"
          fontWeight="500"
          color={AppColor.orange}
        >
