...
const Upgrades = () => {
  ...
  const [activeUpgradeSection, setActiveUpgradeSection] =
    useState('Opened Projects')
  ...
  return (
    <div>
      <Header />
      <NavigationBar currentCategoryTitle="Dashboard" activePageIndex={4} />
        ...
        <div className={styles.main_section}>
          <div className={styles.main_section_left}>
              ...
              <div className={styles.flex}>
                ...
                <div>
                  ...
                  <Typography variant="body4" fontWeight="500">
                    5 lvl{' '}
                    <Typography color={AppColor.whiteGreen}>
                      {' '}
                      Beginner
                    </Typography>
                  </Typography>
            ...
            <div className={styles.upgrade_items_wrapper}>
              <UpgradeItemSection
                activeTitle={activeUpgradeSection}
                onMouseEnter={item => {
                  setActiveUpgradeSection(item)
                }}
                title="Opened Projects"
                count={'3'}
                grade={<div>Grade 1/5</div>}
                icon={<AppColor.overlays />}
              />
              <UpgradeItemSection
                activeTitle={activeUpgradeSection}
                onMouseEnter={item => {
              ...
              <UpgradeItemSection
                ...
                icon={<AppColor.graphicColumnsThree />}
              />
            </div>
          </div>
            ...
            <ActiveUpgradeMenu
              bottomBarText={
                <Typography variant="body4" fontWeight="400">
                  {' '}
                  ensures a trusted marketplace for all users by confirming
                  their identity through the submission and verification of
                  valid documentation.{' '}
                </Typography>
              }
...
const UpgradeItemSection = ({
  ...
  onMouseEnter,
  activeTitle,
}: UpgradeItemSectionProps) => {
  return (
    <div
      style={{
        backgroundColor: activeTitle == title ? AppColor.white : 'transparent',
      }}
      onMouseEnter={() => {
        onMouseEnter(title)
      }}
      className={styles.upgrade_item_section}
    >
      {icon}
      <div className={styles.upgrade_item_text}>
        <Typography variant="body5" fontWeight="500">
          {title}{' '}
          <Typography color={AppColor.transparentBlack}> ({count})</Typography>
        </Typography>
        <Typography variant="body5">{grade}</Typography>
      </div>
    </div>
  )
}
...
const ActiveUpgradeMenu = ({
  ...
  topBarText,
  currentGrade,
}: ActiveUpgradeMenuProps) => {
  return (
    <div>
      <DynamicPadding mobile="30px" desktop="0px" />
      <div className={styles.top_bar_text}>{topBarText}</div>
      ...
      <div className={styles.active_menu_grades_wrapper}>
        ...
        <ActiveUpgradeGradeCircle
          bottomText="1 Project"
          insideText="1"
          active={true}
        />
        <ActiveUpgradeGradeCircle
          bottomText="2 Project"
          insideText="2"
          isNext={true}
        />
        <ActiveUpgradeGradeCircle
          bottomText="3 Project"
          insideText="3"
          disabled={true}
        />
        <ActiveUpgradeGradeCircle
          bottomText="4 Project"
          insideText="4"
          disabled={true}
        />
        <ActiveUpgradeGradeCircle
          bottomText="5 Project"
          insideText="5"
          disabled={true}
        />
      </div>
...
const ActiveUpgradeGradeCircle = ({
  active,
  disabled,
  isNext,
  bottomText,
    ...
    <div className={styles.not_active}>
      <div className={styles.menu_wrapper}>
        <div className={styles.arrow_wrapper}>
          <div
            className={styles.active_upgrade_circle}
            style={{
              border: isNext ? '1px solid #515151' : '1px solid transparent',
          ...
          {active && (
            <div className={styles.chevron_absolute}>
...
const SkillsItem = ({
  ...
  return (
    <div
      ...
      style={activeTitle == title ? { backgroundColor: AppColor.white } : {}}
