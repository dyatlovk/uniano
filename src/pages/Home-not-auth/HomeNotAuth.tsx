...
import {
  AdvantagesSectionCardProps,
  PopularCategorysCatalogCardProps,
  PopularCategorysServiceCardProps,
  sixSectionCardProps,
} from './models'
import {
  advantanges_section_card_content,
  popular_categorys_content_services,
  six_section_cards_content,
} from './content'
...
const popular_categorys_content: PopularCategorysCatalogCardProps[] = [
  {
    ...
    activeIcon: (
      <AppColor.cart height={'15px'} width={'20px'} fill={AppColor.white} />
    ),
    width: 36,
    height: 28,
    title: 'Catalog',
        ...
        <div className={styles.wrapper}>
          ...
          <span className={styles.welcome_text_bottom}>
            <Typography variant="body1" fontWeight="400">
              Explore a world of possibilities! Choose the perfect fit for your
              projects
            </Typography>
          </span>
        </div>
      ...
      <div className={styles.wrapper}>
        ...
        <section className={styles.advantanges_section}>
          ...
          <div className={styles.advantanges_section_subtitle}>
            ...
            >
              Explore endless opportunities with our unified account for all
              user types
            </Typography>
          </div>
          ...
          <div className={styles.advantanges_section_cards}>
            {advantanges_section_card_content.map(item => (
              <AdvantangesSectionCard
                img={item.img}
      ...
      <div className={styles.popular_categorys_wawe}>
        ...
        <div className={styles.wrapper}>
          <section className={styles.popular_categorys}>
            ...
            >
              Explore Popular{' '}
              <span className={styles.popular_categorys_title_orange}>
                Categories
              </span>{' '}
              in Demand
            </Typography>
            ...
            {width <= AppColor.tabletSize ? (
              ...
              <div className={styles.popular_categorys_categorysDisplay}>
                {popular_categorys_content.map((item, index) => (
                  <PopularCategorysCatalogCard
                    callback={item => {
            ...
            <div className={styles.popular_categorys_slider}>
              <Slider
                ...
                elementsCount={popular_categorys_content_services.length}
                gap={20}
              >
                {popular_categorys_content_services.map(item => (
                  <PopularCategorysServiceCard
                    img={item.img}
                    svg={item.svg}
                    title={item.title}
                  />
            ...
            <div className={styles.popular_categorys_skills}>
              <div className={styles.popular_categorys_skills_title}>
                <Typography variant="body3">Popular Skills</Typography>
              </div>
                ...
                {popular_services.map(service => (
                  <Link to={'/service/all'}>
                    <div className={`${styles.hover_text_popular} cursor`}>
                      <Typography
                        title={service}
                        className={styles.hover_text_item}
                        variant="body4"
                      >
                        {service}
                      </Typography>
        ...
        <section className={styles.fourth_screen}>
          <div className={styles.fourth_screen_shell}>
            <div className={styles.fourth_screen_slider}>
              <img
                className={styles.fourth_screen_bc_image}
                src={fourthBcSvg}
                alt=""
              />
              <Slider
              ...
              >
                <CardTime
                  ...
                  currentMoneyRange={500}
                  totalMoneyRange={5000}
            ...
            <div className={styles.fourth_screen_text}>
              ...
              >
                Ignite{' '}
                <span className={styles.fourth_screen_text_grey}>
                  Change Together
                </span>
              </Typography>
              ...
              <div className={styles.fourth_screen_text_margin_top}>
                <Typography
                  ...
                  color={AppColor.transparentBlack}
                >
                  Explore featured campaigns and contribute to projects that
                  resonate with you
                </Typography>
              </div>
                ...
                <ul className={styles.fourth_screen_list_ul}>
                  <li style={{ listStyleImage: `url(${listCheckedSvg})` }}>
                    <Typography variant="body4" fontWeight="400">
                      <span className={styles.fourth_screen_list_bold_text}>
                        Innovation:
                      </span>{' '}
                      Support groundbreaking projects and be part of their
                      success story.
                    </Typography>
                    <SizeBox height="5px" />
                  </li>
                  <li style={{ listStyleImage: `url(${listCheckedSvg})` }}>
                    <Typography variant="body4" fontWeight="400">
                      ...
                      Connect with creators, exchange ideas, and collaborate on
                      unique ventures.
                    </Typography>
                    <SizeBox height="5px" />
                  </li>
                  <li style={{ listStyleImage: `url(${listCheckedSvg})` }}>
                    <Typography variant="body4" fontWeight="400">
                      ...
                      Enjoy special perks, from early access to products to
            ...
            <div className={styles.fourth_screen_details_none_desktop}>
              <ul className={styles.fourth_screen_list_ul}>
                <li style={{ listStyleImage: `url(${listCheckedSvg})` }}>
                  <Typography variant="body4" fontWeight="400">
                    ...
                    Support groundbreaking projects and be part of their success
                    story.
                  </Typography>
                  <SizeBox height="5px" />
                </li>
              ...
              <div
                className={styles.fourth_screen_buttons}
                style={{ gap: '5px' }}
              >
                <MyButton
                  color={AppColor.orange}
          ...
          <section className={styles.fifth_sectin_wrapper}>
            <div className={styles.fifth_sectin_wrapper_flex}>
              <div className={styles.fifth_sectin_wrapper_details_wrapper}>
                ...
                <span
                  className={`${styles.fifth_sectin_details_text_margin} center_mobile_text`}
                >
                  <Typography variant="body4" color={AppColor.transparentBlack}>
                  ...
                  <ul className={styles.fourth_screen_list_ul}>
                    <li style={{ listStyleImage: `url(${pointIcon})` }}>
                      <Typography variant="body4" fontWeight="400">
                        ...
                        Establish lucrative partnerships with freelancers,
                        earning a portion of project revenues for introducing
                        clients or contributing to project success.
                      </Typography>
                      <SizeBox height="5px" />
                    </li>
                    <li style={{ listStyleImage: `url(${pointIcon})` }}>
                      <Typography variant="body4" fontWeight="400">
                        ...
                        Guide clients through the project journey, ensuring a
                        smooth experience and optimal utilization of our
                        platform.
                      </Typography>
                      <SizeBox height="5px" />
                    </li>
                    <li style={{ listStyleImage: `url(${pointIcon})` }}>
                      <Typography variant="body4" fontWeight="400">
                        ...
                        Offer valuable advice to users, covering platform usage,
                        project execution, and leveraging our services for
                        maximum impact.
                      </Typography>
                    </li>
                  </ul>
                ...
                <ul className={styles.fourth_screen_list_ul}>
                  <li style={{ listStyleImage: `url(${pointIcon})` }}>
                    <Typography variant="body4" fontWeight="400">
                      ...
                      Establish lucrative partnerships with freelancers, earning
                      a portion of project revenues for introducing clients or
                  ...
                  <li style={{ listStyleImage: `url(${pointIcon})` }}>
                    <Typography variant="body4" fontWeight="400">
                      ...
                      Guide clients through the project journey, ensuring a
                      smooth experience and optimal utilization of our platform.
                    </Typography>
                    <SizeBox height="5px" />
                  </li>
                  <li style={{ listStyleImage: `url(${pointIcon})` }}>
                    <Typography variant="body4" fontWeight="400">
                      ...
                      Offer valuable advice to users, covering platform usage,
                      project execution, and leveraging our services for maximum
                      impact.
                    </Typography>
                  </li>
                </ul>
              ...
              <div className={styles.fifth_section_images_wrapper}>
                <img
                  width={width <= AppColor.tabletSize ? 61 : 112}
                  height={width <= AppColor.tabletSize ? 61 : 112}
                  src={peoplesImage1}
                  alt="image"
                />
                <img
          ...
          item2={
            <div className="responsive_layout_child">
              <div className={styles.six_section_details}>
                <Typography variant="titleSmall" textTransform="uppercase">
                  <span style={{ color: AppColor.orange }}>Unveiling</span> More
                  Features
                </Typography>
                <div className="center_mobile_text">
                  <span className={styles.six_section_details_span}>
                    <Typography
                      ...
                      color={AppColor.transparentBlack}
                    >
                      Unlock your projects' complete potential. Explore the
...
const AdvantangesSectionCard = ({
  ...
  return (
    <div className={styles.advantanges_section_card_item}>
      <div>
        <img src={img} className={styles.image_auto} alt="image" />
      </div>
...
const PopularCategorysCatalogCard = ({
  icon,
  title,
  subtitle,
  width,
  ...
  return (
    <div
      ...
      style={{
        backgroundColor:
          activeIndex == cardIndex ? AppColor.orange : AppColor.white,
      }}
      className={`${styles.popular_categorys_card} cursor`}
    >
      {cardIndex == activeIndex ? activeIcon : icon}
      <div>
        <Typography
          variant="body5"
          color={activeIndex == cardIndex ? 'white' : AppColor.transparentBlack}
        >
          {title}
        </Typography>
        <Typography
          fontWeight="500"
          variant="body4"
          color={activeIndex == cardIndex ? 'white' : AppColor.text}
        >
          {subtitle}
        </Typography>
      </div>
...
const PopularCategorysServiceCard = ({
  img,
  title,
  svg,
}: PopularCategorysServiceCardProps) => {
  return (
    <div style={{}} className={styles.popular_categorys_services_card}>
      <img
        ...
        src={img}
        alt=""
        className={styles.popular_categorys_card_image}
      />
