...
export const six_section_cards_content: sixSectionCardProps[] = [
...

  {
    title: 'Promo',
    description:
      'Access special offers from freelancers to enhance project value',
...

  {
    title: 'Insurance',
    description:
      'Choose freelancer-provided insurance for added project protection.',
...
export const advantanges_section_card_content: AdvantagesSectionCardProps[] = [
  {
    ...
    title: 'Customers',
    description:
      'Enjoy Commission-Free Projects and Focus on Your Business Growth!',
  },
  ...
  },
  {
    ...
    title: 'Managers',
    description:
      'Streamline Your Project Management with Our Intuitive Tools and Features',
  },
  {
    img: advantagesFourthImage,
    title: 'Sponsors',
    description:
      'Make a Difference by Sponsoring Innovative and Impactful Projects',
  },
]
