...
const MessengerPage = ({ activePageIndex }: MessengerPageProps) => {
  ...
  useEffect(() => {
    if (desktopRef.current && window.innerWidth > 768) {
      setTimeout(() => {
        desktopRef.current.scrollIntoView({
          behavior: 'smooth',
          block: 'start',
        })
      }, 300)
    ...
    <div>
      ...
      >
        <div className={`Messenger_page_wrapper_desktop ${styles.wrapper}`}>
          ...
          <div
            className={`${styles.white_background_right} ${showSidebar ? styles.show_sidebar : styles.remove_sidebar}`}
          >
            <DynamicPadding desktop="30px" mobile="20px" />
            ...
            <div className={styles.padding_desktop}>
              ...
              <div className="gap_10">
                ...
                <div className={styles.flex_column}>
                  <Typography variant="body5" fontWeight="500">
                    Logo by sample in vector in maximum{' '}
                  </Typography>
                  <SizeBox height="5px" />
                  <Typography
                    fontSizeStatic="12px"
    ...
    <div className="gap_10" style={{ alignItems: 'start' }}>
      ...
      <div>
        <div style={{ position: 'relative' }}>
          ...
          <Typography variant="body5" fontWeight="500">
            <span style={{ color: 'transparent' }}>sda</span>
            {fakeUserConstant.name}
...
const FileExampleNotif = () => {
  return (
    <div className="gap_10">
      <AppColor.pdfFile />
      <div className={styles.flex_column}>
        <Typography textLineHeight="1" fontSizeStatic="12px" fontWeight="600">
          requirements{' '}
        </Typography>
        <SizeBox height="5px" />
        <Typography
      ...
      <div>
        ...
        <div className={styles.comment_text}>
          <Typography variant="body5">
            Nulla mauris enim nunc, volutpat. Velit hac aenean aliquet aenean et
            ac. Amet nunc ut sagittis, faucibus nec aliquam malesuada.{' '}
          </Typography>
        </div>
      </div>
...
const CommentPreview = () => {
  ...
  return (
    <div
      ...
      className={styles.comment_preview}
    >
      <div className="flex_space_between">
        <UserAvatar
      ...
      {showModal && (
        <div className="mobile">
          <div
            ...
            className={styles.modal_info_mobile}
          >
...
export const DropdownUserItem = ({
  length,
  node,
  title,
}: DropdownUserItemProps) => {
