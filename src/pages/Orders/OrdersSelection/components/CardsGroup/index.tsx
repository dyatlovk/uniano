    ...
    <div ref={cardsRef} className={styles.wrapper}>
      {items.map((item, id: number) => (
        <CardManager
          ...
          links={['Account', 'Stats', 'Reviews', 'Portfolio', 'Reviews']}
          showCardManagerActions={false}
          absoluteIcons={[
            <AppColor.managersWhite width={11} height={15} />,
            <AppColor.noteCompleted />,
            <AppColor.subscriptionsWhite width={15} height={13} />,
            <AppColor.completed />,
          ]}
          ...
          details={[
            ...
            },
            {
              title: 'Delivery',
              node: (
                <Typography variant="body5" fontWeight="500" textLineHeight="1">
                  12 days
                </Typography>
              ),
            },
