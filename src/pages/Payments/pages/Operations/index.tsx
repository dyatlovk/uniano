  ...
  return (
    <div>
      ...
      <div className={styles.wrapper}>
        <PageDetails
          historyNode={
            <NavigationItem image={<AppColor.home />} textList={['Payments']} />
          }
          endNode={
            <div className={styles.details_items_grid}>
              <DetailsItem
                color={AppColor.green}
                icon={<AppColor.wallet />}
                text="$35 032.93"
              ...
              <DetailsItem
                ...
                icon={<AppColor.caseWhite />}
                text="$35 032.93"
                title="Sponsorhip Balance"
              />
            </div>
          }
              ...
              nodes: [
                <div style={{ maxWidth: '360px' }} className="gap_10">
                  ...
                  <Typography variant="body4" fontWeight="500">
                    Convert an Indicator Signal and an EA Signal into a
