  ...
  return (
    <div>
      {recoverModal && (
        ...
        >
          <Typography textLineHeight="1.5" variant="body4">
            You have <span style={{ fontWeight: '500' }}>5 days</span> to
            recover your account. After your account cannot be recovered.
          </Typography>
      ...
      {deleteModal && (
        ...
        >
          <Typography textLineHeight="1.5" variant="body4">
            Do you want to delete account ? <br />
            <br />
            After <span style={{ fontWeight: '500' }}>30 days</span> your
            ...
            <div className={styles.inputs_wrapper}>
              <InputBorderText
                ...
                labelIcon={
                  <AppColor.passportSvg
                    fill={
                      formData.firstName != '' ? AppColor.text : AppColor.grey
                    }
                    stroke={
                      formData.firstName != '' ? AppColor.text : AppColor.grey
                    }
              ...
              <InputBorderText
                ...
                labelIcon={
                  <AppColor.passportSvg
                    fill={
                      formData.lastName != '' ? AppColor.text : AppColor.grey
                    }
                    stroke={
                      formData.lastName != '' ? AppColor.text : AppColor.grey
                    }
              ...
              <InputBorderTextDropdown
                ...
                labelIcon={
                  <AppColor.earth
                    fill={
                      formData.country != '' ? AppColor.text : AppColor.grey
                    }
                  />
                }
                borderText="Country"
              ...
              <InputBorderText
                ...
                callback={item => {
                  handleCallback('addressLine1', item)
                }}
                placeholderText=""
              />
              <InputBorderText
                ...
                callback={item => {
                  handleCallback('addressLine2', item)
                }}
                placeholderText=""
              />
              <InputBorderText
              ...
              <InputBorderText
                ...
                labelIcon={
                  <AppColor.nameplate
                    fill={
                      formData.postCode != '' ? AppColor.text : AppColor.grey
                    }
                  />
                }
                callback={item => {
        ...
        {!deleted && (
          <div className={styles.delete_wrapper}>
            ...
            <Typography variant="body4" fontWeight="400">
              You can delete your account here. After 30 days your account
              cannot be recovered.
            </Typography>
