        ...
        <div className={styles.left}>
          <div>
            <Typography variant="body4">
              Step 3/3 - Proof of address document
            </Typography>
          ...
          <div className={styles.right_wrapper}>
            ...
            <div style={{ marginLeft: '15px' }}>
              <Typography variant="body4" fontWeight="400">
                • Please include a picture of yourself holding the document and
                a piece of paper next to your face. Write 'Uniano' and today's
                date on the paper. Please make sure that the information on the
                document is clear, readable and identical to the data you have
                indicated in the request form, including: Full name, Date of
                birth.
              </Typography>
              <Typography variant="body4" fontWeight="400">
                • The identification document should expire in at least 6 months
                or more at the time of application submission.
              </Typography>
              <Typography variant="body4" fontWeight="400">
