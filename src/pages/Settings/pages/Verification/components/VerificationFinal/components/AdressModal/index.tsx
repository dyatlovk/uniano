      ...
      <div className={'text_box'}>
        ...
        <div style={{ marginLeft: '15px' }}>
          <Typography variant="body4" fontWeight="400">
            ...
            piece of paper next to your face. Write 'Uniano' and today's date on
            the paper. Please make sure that the information on the document is
            clear, readable and identical to the data you have indicated in the
            request form, including: Full name, Date of birth.
          </Typography>
          <Typography variant="body4" fontWeight="400">
