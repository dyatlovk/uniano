...
import SubscriptionBox, {
  SubscriptionBoxProps,
} from './components/SubscriptionBox'
...
const MySubscription = () => {
  ...
  return (
    <div>
      <Header />
      <NavigationBar activePageIndex={1} currentCategoryTitle="Subscriptions" />
      <div className={styles.wrapper}>
        ...
        <Typography variant="body5">
          <span style={{ fontWeight: '500' }}>{box_content.length}</span>{' '}
          subscriptions
        </Typography>
