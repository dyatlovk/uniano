      ...
      {addModal && (
        ...
        >
          ...
          <InputCommon
            ...
            maxSymbolCount={100}
            placeholder="Write customer promt"
          />
          <SizeBox height="5px" />
          <div className={styles.flex_end}>
            {' '}
          ...
          rows={[
            {
              ...
              title: 'Service Queue',
              titleInfo:
                'Dolor urna augue augue leo. Elit lacus mauris non in euismod amet in tristique netus.',
            },
            {
              card1Text: 'General',
              card2Text: 'Higher priority',
            ...
            },
            {
              ...
              card1Text: (
                <DropdownText
                  callback={() => {}}
                  dropTitles={Array.from(
                    { length: 34 },
                    (_, index) => `${index + 7} days`
                  )}
                  title="7 days"
                />
              ),
