    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.modal_absolute_handler}>
        <PopUpBottom
          ...
          showNodeHover={<AppColor.threeLinesActive />}
          showNode={<AppColor.threeLines />}
          popUpNode={
      ...
      <div className={styles.main_wrapper}>
        <Typography fontWeight="500" textTransform="uppercase" variant="body4">
          {title}
        </Typography>
        {members.length > 0 ? (
        ...
        <Typography variant="body4">{members.length} Members</Typography>
      </div>
    </div>
  )
}
